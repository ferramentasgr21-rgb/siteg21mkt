...
export const metadata: Metadata = {
  ...
  description: 'Tire suas dúvidas sobre a consultoria integrada da GR21: modelo de atuação e serviços.',
};
...
export default function FaqPage() {
  return (
    <>
      ...
      <CtaBand title="Ainda tem dúvidas?" subtitle="Entre em contato. Será um prazer entender como podemos ajudar sua incorporadora." primaryLabel="Fale com a GR21" />
    </>
  );
}
