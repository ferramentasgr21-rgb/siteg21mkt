...
const PILARES = [
  ...
  },
  {
    ...
    desc: 'KPIs e metas claras. Você acompanha cada real investido e cada resultado gerado. Transparência total, performance comprovada.',
  },
  {
    icon: ShieldCheck,
...
export default function SobrePage() {
  return (
    <>
      ...
      <CtaBand
  title="Vamos construir o sucesso da sua incorporadora juntos?"
  subtitle="Agende uma conversa estratégica com a GR21 e entenda como podemos integrar marketing, vendas e gestão comercial para acelerar seus resultados."
