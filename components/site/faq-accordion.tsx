...
const FAQS = [
  ...
  { q: 'Preciso ter CRM implantado para trabalhar com vocês?', a: 'Não. Se você não tem CRM, fazemos a análise e implantação. Também Integramos com outras plataformas que você já utilize. O importante é ter processo, controle e dados para otimizar resultados.' },
